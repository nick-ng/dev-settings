...
(() => {
  ...
  const temp0 = [...document.querySelectorAll('div[data-test-id="ref-spotlight-target-status-spotlight"] button')]
  ...
  const temp = [...document.querySelectorAll('div[data-test-id="issue-field-status.ui.status-view.transition"]')]
